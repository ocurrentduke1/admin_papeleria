...
Revision ID: 19f773d88e78
Revises: 
Create Date: 2026-03-09 22:08:58.835072
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'EMPLOYEE', 'CLIENT', name='role'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'CONFIRMED', 'PREPARING', 'SENT', 'DELIVERED', 'CANCELLED', name='order_status_type'), nullable=False),
    ...
    sa.Column('type', sa.Enum('IN', 'OUT', 'ADJUSTMENT', name='movements_type'), nullable=False),
